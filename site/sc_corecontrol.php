...
<h2 class="news">c-base Core Control</h2>

<p>
In old air-raid shelters underneath Berlin Alexanderplatz, members of the <a href="http://www.c-base.org">c-base space station</a>  discovered parts of its drive mechanism. We were able to discern the workings of the energy store, the moebius band accumulator. Through the moebius mechanism, the accumulator is able to store infinite amounts of energy. We displayed the uncovered parts along with a description of the findings in the 2003 exhibition <a href="http://www.paradiesprojekt.de">'Paradies'</a>, in which over 200 artists used the many rooms of the bunker to show their vision of paradise.</p>
<p>
The core control application that displayed the current drive mechanism was programmed using an early version of libavg.</p>
...
dropimages[0]="images/showcase/core_control1.jpg"
dropimages[1]="images/showcase/core_control2.jpg"
